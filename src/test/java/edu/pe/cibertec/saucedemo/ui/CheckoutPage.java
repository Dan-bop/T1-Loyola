...
public class CheckoutPage {
    ...
    public static final String FIRST_NAME_FIELD = "[data-test='firstName']";
    public static final String LAST_NAME_FIELD  = "[data-test='lastName']";
    public static final String POSTAL_CODE_FIELD= "[data-test='postalCode']";
    ...
    public static final String CONFIRMATION_MSG = "[data-test='complete-header']";
    public static final String ERROR_MESSAGE    = "[data-test='error']";
    public static final String CHECKOUT_FORM    = "[data-test='checkout-info-container']";
}